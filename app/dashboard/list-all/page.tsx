...
function ListAll() {
  ...
  return (
    <>
      <div className="w-full grid  md:grid-cols-3 grid-cols-1 md:gap-7 gap-x-4 gap-y-2 md:px-0 pr-10">
        <div className="bg-primary md:min-h-32 min-h-28 rounded-2xl flex flex-col items-start justify-center p-3">
          <h3 className=" text-primary-foreground">Total Listed Properties</h3>
          <div className="mt-2 flex items-center gap-3">
            ...
            <h3 className="text-primary-foreground font-bold text-4xl drop-shadow font-sans">
              53
            </h3>
          </div>
        </div>
        <div className="bg-secondary md:min-h-32 min-h-28 rounded-2xl flex flex-col items-start justify-center p-3">
