...
function PeshawarRentPageContent() {
  return (
    <section className="md:w-11/12  w-full mx-auto mt-16 min-h-screen">
      <section className="py-24 ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 lg:mb-16 flex justify-center items-center flex-col gap-x-0 gap-y-6 lg:gap-y-0 lg:flex-row lg:justify-between max-md:max-w-lg max-md:mx-auto">
            <div className="relative w-full text-center lg:text-left lg:w-2/4">
              <h2 className="text-4xl font-bold text-gray-900 md:leading-[3.25rem] lg:mb-6 mx-auto max-w-max lg:max-w-md lg:mx-0">
                Find Affordable Rental Properties in Peshawar
              </h2>
            </div>
            <div className="relative w-full text-center  lg:text-left lg:w-2/4">
              <p className="md:text-lg text-base font-normal text-gray-500 mb-5">
                As one of the most planned cities in South Asia, Peshawar is
          ...
          <p className="md:text-lg text-base font-normal text-gray-500 mb-5">
            Looking to rent properties in Peshawar within your budget? Peshawar,
            the capital city of Pakistan, is renowned for its modern
            infrastructure, scenic beauty, and high-quality living standards.
            Nestled against the lush green Margalla Hills, Peshawar offers a
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            ...
            <h2 className="text-4xl text-center font-bold text-gray-900 py-5">
              Why Rent in Peshawar?
            </h2>
            <p className="max-w-4xl mx-auto">
              Renting in Peshawar offers flexibility, access to modern
          ...
          <div className="flex justify-center items-center gap-x-5 gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
            <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
              ...
              <p className="text-base font-normal text-gray-600">
                Peshawar is famous for its clean environment, well-maintained
            ...
            <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
              ...
              <p className="text-base font-normal text-gray-600">
                ...
                embassies, Peshawar provides premium rental opportunities in
            ...
            <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
              ...
              <p className="text-base font-normal text-gray-600">
                ...
                census), Peshawar continues to grow, driving demand for rental
            ...
            <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
              ...
              <p className="text-base font-normal text-gray-600">
                Known as one of Pakistan&lsquo;s safest cities, Peshawar offers
      ...
      <section className="py-24 -mt-10">
        <div className="">
          ...
          <h2 className="text-4xl  text-center mt-6">
            Explore Rental Property Types in Peshawar
          </h2>
          <p className="text-center mt-6 text-lg font-light text-gray-500">
            ...
            in Peshawar&lsquo;s most desirable locations.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="md:p-8 p-5">
            ...
            <p className="font-light text-sm text-gray-500 mb-3">
              Looking for open spaces to lease? Peshawar offers options for
      ...
      <div className="mx-auto max-w-7xl px-3 lg:px-8">
        <div className="mx-auto max-w-7xl lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <h2>Top Areas to Rent Properties in Peshawar</h2>
            <p className="mt-6 md:text-lg/8 text-base text-gray-600">
              Explore the most sought-after rental locations in Peshawar,
      ...
      <div className="py-20 md:px-0 px-3 flex flex-col gap-y-4 max-w-4xl mx-auto -mt-10">
        ...
        <p className="md:text-lg text-base">
          Peshawar, with its exceptional living standards, modern
          ...
          luxurious villas, or commercial spaces, Peshawar has rental options to
          suit everyone. Find your ideal rental property in the capital city
...
export default PeshawarRentPageContent;
