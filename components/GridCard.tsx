...
function GridCard({ property }: { property: SinResProperty }) {
  ...
  return (
    <div className="col-span-3 bg-white drop-shadow-lg grid md:grid-cols-5 grid-cols-1 rounded-xl p-2 gap-5 mb-4">
      ...
      <div className="md:py-2 pb-2 md:col-span-3 col-span-5 flex flex-col items-start justify-between">
        <div>
        ...
        <div className="flex item-center mt-3 w-full justify-between">
          <Link href={`/property/${property.slug}`}>
