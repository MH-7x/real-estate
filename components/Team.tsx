...
export default function OurTeam() {
  return (
    <>
      <section className="relative bg-gradient-to-t to-black/70 via-black/80 from-black/90 text-white md:py-32 py-20 mt-16 md:px-8 px-3">
        {/* Background Image */}
        <div
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-24">
            ...
            <p className="text-lg text-gray-500 text-center">
              Connect with our expert team for personalized real estate
              solutions.
            </p>
          </div>
              ...
              >
                ...
                <div className="text-center lg:text-left lg:max-w-xs flex-1">
                  <div className="mb-5 pb-5 border-b border-solid border-gray-300">
                    ...
                    <span className="text-sm text-primary">{person.post}</span>
                  </div>
